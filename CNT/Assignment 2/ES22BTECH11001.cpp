...
// Input: a triplet (n, a, b)
// Output: a single value, a^b if it exists, else an error message
int main(){
    // Initialize the numbers as defined in the question
    mpz_t n, a, b;
    mpz_inits(n, a, b, NULL);

    gmp_scanf("%Zd %Zd %Zd", n, a, b);
    ...
    mpz_t current_value, answer;
    mpz_inits(current_value, answer, NULL);
